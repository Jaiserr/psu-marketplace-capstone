            ...
            <div class="relative overflow-hidden">
                <div class="relative">
                    <div class="text-lg max-w-prose mx-auto">
                        ...
                        <p class="mt-8 text-xl py-2 text-gray-500 leading-8">Welcome to PSU Marketplace. Greetings! We're thrilled to welcome you to PSU Marketplace, a dynamic platform tailored for our
                            vibrant community of students, faculty, and the wonderful residents of our Alaminos City.
                        </p>
                    </div>
                    <div class="mt-6text- center prose prose-indigo prose-lg text-gray-500">
                        <span class="mt-4 block text-xl text-center leading-8 font-extrabold tracking-tight text-gray-900">Our Mission</span>
                        <h1 class="mt-4 text-center">At PSU Marketplace, our mission is to create a space that goes beyond transactions. We aim to foster
                        ...
                        <h1 class="mt-4 text-center">What makes us unique is our commitment to community-centric values. PSU Marketplace is your go-to
                        ...
                        <h1 class="mt-4 text-center">We're excited to have you with us! Connect with PSU Marketplace on social media, and don't hesitate to
