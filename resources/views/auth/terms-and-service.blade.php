<div x-data="{createOpen:false}" class="inline">
    ...
    {{-- <div x-show="createOpen" x-cloak>
        <div class="fixed bg-slate-50 shadow-md rounded-md top-2/4 left-2/4 w-3/4 -translate-y-2/4 -translate-x-2/4"
            style="z-index: 501;">
            <div class="p-6 relative bg-white overflow-hidden">
                <div class="relative">
                ...
                <div class="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
                    ...
                    <span class="mt-2 block text-sm text-start leading-8 font-extrabold tracking-tight text-gray-900">Last updated: November 29,2002</span>
