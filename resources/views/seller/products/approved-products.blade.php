    ...
    <div class="bg-white dark:bg-gray-800 relative shadow-lg rounded-lg overflow-hidden">
        <div class="flex flex-col md:flex-row items-center justify-end space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <a href="{{ route('admin-products.create') }}" class="flex items-center justify-center text-white bg-indigo-600 hover:bg-indigo-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                ...
                <div class="flex items-center space-x-3 w-full md:w-auto">
                    ...
                    <div id="actionsDropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton">
                            <li>
                                <a href="{{ url('admin-products')}}" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">All Items</a>
                            </li>
                        </ul>
                        <div class="py-1">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-white uppercase bg-blue-900">
                    <tr>
                        <th scope="col" class="px-4 py-3 sr-only">Product Image</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b dark:border-gray-700">
                        <td class="px-4 py-3">
                            <img src="{{ asset('storage/' . $imagePathsArray[0]) }}" class="w-16  max-w-full max-h-full" alt="{{ $product->product_name }}">
                        </td>
                        ...
                        <td class="px-4 py-3 text-green-500">Approved</td>  
                        <td class="px-4 py-3">
