        ...
        <ol role="list" class="bg-white rounded-md shadow px-6 flex space-x-4">
            ...
            <li class="flex">
                <div class="flex items-center">
                    ...
                    <a href="#" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700">Search Products</a>
                </div>
            </li>
        </ol>
    </nav>
    <div class="bg-white">
        <div class="py-10 sm:py-10 lg:max-w-7xl lg:mx-auto lg:px-8">
            <div class="px-4 flex items-center justify-between sm:px-6 lg:px-0">
                <h2 class="text-2xl font-extrabold tracking-tight text-gray-900">Search Results for "{{ $query }}"</h2>
            </div>
                    ...
                    <ul role="list" class="mx-4 inline-flex space-x-8 sm:mx-6 lg:mx-0 lg:space-x-0 lg:grid lg:grid-cols-4 lg:gap-x-8">
                        ...
                        @empty
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                <h2 class="text-4xl font-extrabold tracking-tight text-gray-900">No result found!</h2>
                            </div>
                        @endforelse
                    </ul>
                </div>
