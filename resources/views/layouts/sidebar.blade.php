...
<aside class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition duration-700 ease-in-out -translate-x-full shadow-lg bg-white md:translate-x-0 dark:bg-gray-800"
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-indigo-50 dark:bg-gray-800">
        ...
        <ul class="space-y-2 mb-5 pb-5 border-b border-gray-200 dark:border-gray-700">
            ...
            <li>
                <button
                    type="button"
                    class="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-indigo-600 hover:text-white dark:hover:bg-gray-700"
                    aria-controls="dropdown-pages"
                    data-collapse-toggle="dropdown-pages"
                    >
                    <svg class="flex-shrink-0 w-5 h-5 text-blue-900 transition duration-75 group-hover:text-white dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M17.876.517A1 1 0 0 0 17 0H3a1 1 0 0 0-.871.508C1.63 1.393 0 5.385 0 6.75a3.236 3.236 0 0 0 1 2.336V19a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-6h4v6a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V9.044a3.242 3.242 0 0 0 1-2.294c0-1.283-1.626-5.33-2.124-6.233ZM15.5 14.7a.8.8 0 0 1-.8.8h-2.4a.8.8 0 0 1-.8-.8v-2.4a.8.8 0 0 1 .8-.8h2.4a.8.8 0 0 1 .8.8v2.4ZM16.75 8a1.252 1.252 0 0 1-1.25-1.25 1 1 0 0 0-2 0 1.25 1.25 0 0 1-2.5 0 1 1 0 0 0-2 0 1.25 1.25 0 0 1-2.5 0 1 1 0 0 0-2 0A1.252 1.252 0 0 1 3.25 8 1.266 1.266 0 0 1 2 6.75C2.306 5.1 2.841 3.501 3.591 2H16.4A19.015 19.015 0 0 1 18 6.75 1.337 1.337 0 0 1 16.75 8Z"/>
                    </svg>
                ...
                <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                    <li>
                        <a
                            ...
                            class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-indigo-600 hover:text-white dark:text-white dark:hover:bg-gray-700"
                            >All Items</a>
                    </li>
                    <x-link :href="route('admin-products.index')" :actives="request()->routeIs('admin-products.*')">
                        {{ __('All Items') }}
                    </x-link>
                    <li>
                        <a
            ...
            {{-- <li>
                <a
                    href="{{ url('academic-resource-exchange-products' )}}"
                    class="flex items-center p-2 text-base font-medium text-gray-900 rounded-lg hover:bg-indigo-600 hover:text-white dark:hover:bg-gray-700 group"
                    >
                    <svg class="w-6 h-6 text-blue-900 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
                    ...
                    <span class="ml-3">Academic Resource Exchange</span>
                </a>
            </li> --}}
         ...
         <ul
            ...
            <li>
                <a
                    ...
                    <svg
                        aria-hidden="true"
                        class="flex-shrink-0 w-6 h-6 text-blue-900 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                        >
    ...
    <div
        class="absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-indigo-50 z-20"
        >
        <a
            href="#"
