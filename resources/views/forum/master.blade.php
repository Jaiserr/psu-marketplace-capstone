...
<body class="bg-gray-100">
    ...
    <footer class="bg-indigo-700">
        <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            <p class="mt-8 text-center text-base text-white">Contact Us On</p>
            <div class="mt-8 flex justify-center space-x-6">
                <a href="https://www.facebook.com/profile.php?id=61553673545550&mibextid=vk8aRt" class="text-white hover:text-gray-500">
            ...
            <p class="mt-8 text-center text-base text-white">&copy; 2023 Pangasinan State University Marketplace, All rights reserved.</p>
        </div>
      </footer>
